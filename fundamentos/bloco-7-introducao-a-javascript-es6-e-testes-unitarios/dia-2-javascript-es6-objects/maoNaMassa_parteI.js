const order = {
  ...
  const orderModifier = (order) => {
    let saborUm = Object.keys(order.order.pizza);
    order.name = 'Luiz Silva';
    order.order.payment = 50;
    console.log(`Olá ${order.name}, o total do seu pedido de ${saborUm[0]}, ${saborUm[1]} e ${order.order.drinks.coke.type} é R$ ${order.order.payment},00.`);
